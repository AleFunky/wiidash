...
int main_levels() {
    ...
    //if (enable_info) {
        char cpu_usage[64];
        snprintf(cpu_usage, sizeof(cpu_usage), "SYS_GetArena1Lo %p Free MEM1: %d Free MEM2: %d",SYS_GetArena1Lo(), SYS_GetArena1Hi() - SYS_GetArena1Lo(), SYS_GetArena2Hi() - SYS_GetArena2Lo());
